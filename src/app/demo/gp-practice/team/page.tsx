...
export default function TeamPage() {
  return (
    <>
      ...
      <GpSection>
        <figure>
          <Image
            ...
            width={1580}
            height={1280}
            className="max-h-[340px] w-full rounded-[var(--dgp-radius-lg)] object-cover object-[50%_22%] shadow-[0_1px_2px_rgba(16,42,67,0.05),0_16px_32px_-24px_rgba(16,42,67,0.35)]"
          />
      ...
      <GpSection pad="flush">
        <div className="rounded-[var(--dgp-radius-lg)] bg-[var(--dgp-tint)] p-6 sm:p-8">
