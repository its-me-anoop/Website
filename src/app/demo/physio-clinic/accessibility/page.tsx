...
function StatementSection({
  ...
  return (
    <section>
      <h2 className="text-xl font-bold tracking-tight text-[var(--dpy-ink)]">{title}</h2>
...
export default function AccessibilityPage() {
  const { accessibility, clinic } = loadPhysioContent();

  return (
    <>
      <PhysioPageHero
        eyebrow="How this site works for you"
      ...
      <PhysioSection className="max-w-[820px]">
        <div className="space-y-8 text-base leading-relaxed text-[var(--dpy-ink-soft)]">
          ...
          <StatementSection title="Tell us if something isn't working">
            ...
            <p>
              ...
              <a
                ...
                className="text-[var(--dpy-coral)] underline underline-offset-2"
              >
                {accessibility.reporting.email}
              </a>{" "}
              or call us on{" "}
              <a href={clinic.phoneHref} className="text-[var(--dpy-coral)] underline underline-offset-2">
                {clinic.phone}
              </a>
              .
            </p>
          ...
          <p className="border-t border-[var(--dpy-line)] pt-5 text-sm">
            This statement is part of a sample website built by Flutterly.
          </p>
        </div>
        <PhysioReviewDate reviewed={accessibility.reviewed} />
      </PhysioSection>
    </>
  );
}
