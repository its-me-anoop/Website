...
import { AuditBar } from "../ui/primitives";
    ...
    <Shell>
      ...
      {state.kind === "idle" ? (
        <PageHero
          ...
          copy={
            <p>
              Accessibility, speed, search, content, mobile, security and local presence, scored and explained in
              plain English. Free, instant, and nothing is stored.
            </p>
          }
        >
          <AuditBar autoFocus align="center" hint="Enter the address and press the arrow." />
        </PageHero>
      ) : null}
        ...
        <>
          <div className="k-screen">
            <section className="relative isolate overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-24">
              <div aria-hidden className="a-blobs -z-10 opacity-50">
                <span />
                <span />
                <span />
              </div>
              <div aria-hidden className="a-grid absolute inset-0 -z-10 opacity-50" />
