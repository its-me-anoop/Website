      ...
      <Reveal delay={0.08} className="mt-8 flex flex-wrap items-center justify-center gap-3">
        {retryable ? (
          <button
            type="button"
            onClick={onRetry}
            className="a-shine inline-flex h-12 items-center justify-center rounded-full bg-a-amber px-6 text-[15px] font-medium text-a-void transition-colors hover:bg-a-amber-hover"
          >
            Try again
          </button>
        ) : null}
