              ...
              >
                <span
                  ...
                  className={cn(
                    ...
                    done ? "bg-a-lime/15 ring-a-lime/40 text-a-lime" : active ? "ring-a-lime" : "ring-a-line-2"
                  )}
                >
                  {done ? <Check size={12} strokeWidth={3} /> : active ? <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-a-lime" /> : null}
                </span>
                {label}
              </li>
            );
