    ...
    <div className={cn("w-full", className)}>
      ...
      <p className="mt-4 text-center text-[14px] leading-snug text-a-muted">
        ...
        <a
          ...
          className="inline-flex items-center gap-1 text-a-ink underline decoration-a-line-2 underline-offset-4 transition-colors hover:decoration-a-lime"
        >
