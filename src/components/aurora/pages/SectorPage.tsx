...
import { Reveal, ScrollTilt, Tilt } from "../effects/Motion";
    ...
    <Shell>
            ...
            <ul className="mt-10 grid gap-3 sm:grid-cols-3">
              {sector.heroPoints.map((point, i) => (
                <Reveal as="li" key={point} delay={i * 0.06} className="a-glass rounded-[20px] px-5 py-4">
                  <span className="a-mono text-[11px] text-a-lime">0{i + 1}</span>
      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        <div
          ...
          style={{ background: "linear-gradient(120deg,#1fb8c9,#6d5bff)" }}
        />
          ...
          <Reveal>
            <div className="a-conic grid gap-12 rounded-[36px] bg-a-deep p-8 sm:p-12 lg:grid-cols-[1fr_1fr] lg:gap-16 lg:p-16">
              <div>
                <span
                  aria-hidden
                  className="flex h-14 w-14 items-center justify-center rounded-2xl bg-a-lime/10 text-a-lime ring-1 ring-a-lime/30"
                >
