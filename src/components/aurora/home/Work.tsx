  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: `linear-gradient(160deg, ${project.tint}, #1a1511 140%)` }}
      >
        <Image
          src={project.image}
          alt=""
        ...
        <span
          aria-hidden
          className="absolute right-5 top-5 flex h-10 w-10 items-center justify-center rounded-full bg-a-amber text-a-void opacity-0 transition-[opacity,transform] duration-500 group-hover:rotate-45 group-hover:opacity-100"
        >
          <ArrowUpRight size={18} />
        </span>
      </div>
      <div className="flex flex-1 flex-col p-7">
        <p className="a-mono text-[11.5px] uppercase tracking-[0.14em] text-a-gold">
