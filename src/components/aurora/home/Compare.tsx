              ...
              <tbody className="max-md:block">
                {comparison.rows.map((row) => (
                  <tr key={row.label} className="border-t border-a-line max-md:block max-md:px-6 max-md:py-6">
                    ...
                    <td className="bg-gradient-to-r from-a-amber/[0.07] to-a-gold/[0.05] px-7 py-6 align-top text-[15px] leading-[1.6] text-a-ink max-md:mt-3 max-md:block max-md:rounded-[14px] max-md:p-4">
                      <span className="flex items-start gap-3">
