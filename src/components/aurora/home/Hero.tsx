    ...
    <section ref={ref} id="top" className="relative isolate flex min-h-[100svh] flex-col overflow-hidden">
      <div aria-hidden className="absolute inset-0 -z-10 bg-a-void">
        ...
        <div
          ...
          style={{ background: "radial-gradient(ellipse 48% 42% at 50% 55%, rgba(5,6,11,0.62), transparent 100%)" }}
        />
      ...
      >
        ...
        >
          <span className="a-mono rounded-full bg-a-lime px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.08em] text-a-void">
            New
          </span>
      ...
      >
        ...
        <Magnetic className="absolute -top-16 right-8 hidden xl:inline-flex">
          ...
          >
            ...
            <ArrowRight size={18} aria-hidden className="rotate-90 text-a-lime transition-transform group-hover:translate-y-1" />
          </a>
        </Magnetic>
      </div>
    </section>
