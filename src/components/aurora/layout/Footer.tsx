  ...
  return (
    <footer className="relative overflow-hidden border-t border-a-line bg-a-void">
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 80% at 50% 110%, rgba(155,140,255,0.35), rgba(69,227,212,0.12) 45%, transparent 75%)",
        }}
      />
              ...
              {[
                ...
                <li key={row.email} className="flex flex-wrap gap-x-3">
                  ...
                  <a
                    ...
                    className="text-a-ink underline decoration-a-line-2 underline-offset-4 transition-colors hover:decoration-a-lime"
                  >
                    {row.email}
                  </a>
                </li>
              ...
              <div key={column.title}>
                ...
                <ul className="mt-5 space-y-3">
                  {column.links.map((link) => {
                    ...
                    const classes = "text-[14.5px] text-a-ink-soft transition-colors hover:text-a-lime";
                    return (
                      <li key={link.label}>
                        {external ? (
