    ...
    <header className="pointer-events-none fixed inset-x-0 top-0 z-[120] px-3 pt-3 sm:px-5 sm:pt-4">
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link
            href="/book"
            className="a-shine inline-flex h-10 items-center rounded-full bg-a-lime px-4 text-[14px] font-medium text-a-void transition-colors hover:bg-a-lime-hover"
          >
            Book a call
          </Link>
          <button
          ...
          >
            ...
            <div className="mt-4 grid gap-2 border-t border-a-line p-2 pt-4 sm:grid-cols-2">
              ...
              <Link
                href="/book"
                onClick={() => setOpen(false)}
                className="rounded-full bg-a-lime px-4 py-3 text-center text-[15px] font-medium text-a-void transition-colors hover:bg-a-lime-hover"
              >
                Book a call
              </Link>
            </div>
