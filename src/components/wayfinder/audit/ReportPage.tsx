...
export function ReportPage() {
  ...
  return (
    <Shell>
      ...
      {state.kind === "idle" ? (
        <PageHero
          kicker="Instant website audit"
          title={
            <>
              Check any website <mark className="wf-mark">in seconds.</mark>
            </>
          }
          copy={
            <p>
      ...
      {state.kind === "done" ? (
        <>
          <div className="k-screen">
            <section className="border-b-2 border-wf-ink pb-14 pt-12 sm:pb-20 sm:pt-16">
            ...
            <CtaBand
              title={
                <>
                  Audit another site, or <mark className="wf-mark">talk it through.</mark>
                </>
              }
