...
The audit bar on every Wayfinder page submits a native GET form to
...
is not the web page but `wayfinder/audit/print/PrintReport.tsx`, a designed
...
it reads as paper while the on-screen report runs Wayfinder:
